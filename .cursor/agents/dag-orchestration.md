# DAG orchestration playbook (`/dag-execute`)

Long-form workflow for the DAG-driven pipeline. **Index and pointers:** [`/workspace/AGENTS.md`](/workspace/AGENTS.md). **Envelope contract:** [`/workspace/.cursor/skills/json-handoff/SKILL.md`](/workspace/.cursor/skills/json-handoff/SKILL.md).
