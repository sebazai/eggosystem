...
| Ops → worktree (readiness)   | After Ops: `{ worktree_path, issue_iid }` + **`CONTEXT.local.md` stub** in the worktree root (see [`.cursor/templates/CONTEXT.local.template.md`](.cursor/templates/CONTEXT.local.template.md))                                                                                | `ops_bot` Bash in worktree only |
