...
4. Run the quality gates from the repo root (cd to root first):
```
...
```
5. If any quality gate fails or you find a violation, fix it. Re-run the gates to confirm they pass.
