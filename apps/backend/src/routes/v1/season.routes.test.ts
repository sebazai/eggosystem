...
import { getTeamCaptainsBySeasonIdController } from "../../controllers/seasons.controllers";
...
const createUnauthenticatedTestApp = () => {
  ...
  const mockAuthMiddleware = (
    ...
    // Don't set auth for missing tokens - this simulates the real behavior
    next();
  };
...
describe("Season Routes - Captains Endpoints", () => {
