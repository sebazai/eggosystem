...
describe("parseDemoUrl", () => {
  ...
  describe("invalid demo URLs", () => {
    it("should return null for non-URL strings", () => {
      const result = parseDemoUrl("not-a-url");
    ...
    it("should return null for empty string", () => {
      const result = parseDemoUrl("");
      expect(result).toBeNull();
    });

    it("should return null for null input", () => {
      const result = parseDemoUrl(null as unknown as string);
      expect(result).toBeNull();
    });

    it("should return null for undefined input", () => {
      const result = parseDemoUrl(undefined as unknown as string);
      expect(result).toBeNull();
    });
  });
