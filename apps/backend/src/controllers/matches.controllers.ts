...
export const getMatchesByFiltersController = async (req: Request, res: Response): Promise<void> => {
  ...
  const matches = await getMatchesByFilters(teamid, seasonid, map, leagueid, stage);

  res.json(matches);
};

export const getTopPlayersController = async (req: Request, res: Response): Promise<void> => {
...
export const getMatchPlayerStatsController = async (req: Request, res: Response): Promise<void> => {
  const matchid: number = parseInt(req.params.matchid, 10);
...
export const getMatchTeamStatsController = async (req: Request, res: Response): Promise<void> => {
  const matchid: number = parseInt(req.params.matchid, 10);
