...
Full command catalog for shell tooling. **Golden rule summary:** always prefix with `rtk` except repo-root typecheck uses `pnpm typecheck` (no RTK); hooks enforce allowed typecheck shapes.
...
### Files and Search (60-75% savings)
...
### Analysis and Debug (70-90% savings)
